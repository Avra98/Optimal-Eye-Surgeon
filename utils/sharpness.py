...
def compute_hvp(network: nn.Module, ind_loss, net_input_list, img_np_list, img_noise_np_list, 
    ...
    vector = vector.cuda()
    loss = ind_loss(network,net_input_list,img_np_list,img_noise_np_list)
...
def get_hessian_eig(network: nn.Module, ind_loss, net_input_list, img_np_list, img_noise_np_list, 
                            neigs=6):
